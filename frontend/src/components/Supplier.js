        ...
        <div class="main-container">
          ...
          <div id="customers" data-aos="fade-up" class="right-side">
            ...
            <div id="add-customers-btn" class="add-btn">
              <button onClick={(e) => showPopup(e)}>Add Supplier</button>
            </div>
            ...
            <div>
              {items.map((curElem,index) => {
                ...
                return (
                  <Accordion  expanded={expandedIndex === index}
                  onChange={() => handleAccordionChange(index)} className="eachItem" key={curElem.id}>
                    <AccordionSummary
                    ...
                    <AccordionDetails>
                      <Typography>
                        <div className="del">
                          <button onClick={() => EnteriesPopup(currentCustomerId)}>
                            Add Enteries
                          </button>
